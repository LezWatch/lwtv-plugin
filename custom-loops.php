 ...
 */
function lwtv_tax_query( $post_type, $taxonomy, $field, $term, $operator = 'IN' ) {
 ...
 * @return array The WP_Query Array
 */
function lwtv_tax_two_query( $post_type, $taxonomy1, $field1, $terms1, $taxonomy2, $field2, $terms2, $operator1 = 'IN', $operator2 = 'IN' ) {
	$query = new WP_Query ( array(
		'post_type'       => $post_type,
		'posts_per_page'  => -1,
		'no_found_rows'   => true,
...
function lwtv_post_type_query( $post_type ) {
	$query = new WP_Query ( array(
			'post_type'       => $post_type,
			'posts_per_page'  => -1,
			'orderby'         => 'title',
...
function lwtv_post_meta_and_tax_query( $post_type, $key, $value, $taxonomy, $field, $terms, $compare = '=', $operator = 'IN' ) {
	$query = new WP_Query( array(
		'post_type'       => $post_type,
		'posts_per_page'  => -1,
		'no_found_rows'   => true,
