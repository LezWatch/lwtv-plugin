...
$characters = lwtv_plugin()->generate_statistics( 'characters', 'total', 'count' );
$shows      = lwtv_plugin()->generate_statistics( 'shows', 'total', 'count' );
$actors     = lwtv_plugin()->generate_statistics( 'actors', 'total', 'count' );
$dead_chars = lwtv_plugin()->generate_statistics( 'characters', 'dead', 'count' );
?>
