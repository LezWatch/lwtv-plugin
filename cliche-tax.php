...
function cliche_taxonomy() {

        $labels = array(
                'name'                       => _x( 'Clichés', 'Taxonomy General Name', 'lezwatchtv' ),
                ...
                'separate_items_with_commas' => __( 'Separate cliche names with commas', 'lezwatchtv' ),
                'search_items'               => __( 'Search Clichés', 'lezwatchtv' ),
                'add_or_remove_items'        => __( 'Add or remove sharacters', 'lezwatchtv' ),
                'choose_from_most_used'      => __( 'Choose from the most used cliche name', 'lezwatchtv' ),
...
add_action( 'init', 'cliche_taxonomy', 0 );
