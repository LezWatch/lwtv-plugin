...
class LWTV_Calendar_Blocks {
	...
	public function make() {
		 ...
		 * Calendar itself
		 */
		$calendar = ( new LWTV_Rest_API_Whats_On_JSON() )->generate_tvshow_calendar( $start_datetime->format( 'Y-m-d' ) );
	...
	public function show_name( $name ) {
		return ( new LWTV_Calendar_Names() )->make( $name, 'tvmaze' );
	}
