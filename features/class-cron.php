...
class LWTV_Features_Cron {
	...
	public function missed_schedule() {
		...
		$missed_transient = LWTV_Features_Transients::get_transient( 'lwtv_missed_schedule' );
...
SQL;
	...
	public function lists_daily() {
		$count_shows = LWTV_Features_Transients::get_transient( 'lwtv_count_shows' );
		...
		$count_actors = LWTV_Features_Transients::get_transient( 'lwtv_count_actors' );
	...
	public function tools_check() {
		...
		switch ( gmdate( 'D' ) ) {
			case 'Mon':
				( new LWTV_Debugger_Actors() )->find_actors_problems();
				break;
			case 'Tue':
				( new LWTV_Debugger_Actors() )->find_actors_no_imdb();
				break;
			case 'Wed':
				( new LWTV_Debugger_Actors() )->find_actors_incomplete();
				break;
			case 'Thu':
				( new LWTV_Debugger_Queers() )->find_queerchars();
				break;
			case 'Fri':
				( new LWTV_Debugger_Characters() )->find_characters_problems();
				break;
			case 'Sat':
				( new LWTV_Debugger_Shows() )->find_shows_problems();
				break;
			case 'Sun':
				( new LWTV_Debugger_Shows() )->find_shows_no_imdb();
				break;
		}
	}
