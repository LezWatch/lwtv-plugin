...
if ( !class_exists( 'Forked\CMB2\CMB2Grid\Grid\Group\GroupRow' ) ) {
     ...
     * @author Pablo
     */
    class GroupRow extends \Forked\CMB2\CMB2Grid\Grid\Row {
        ...
        protected function openGroupRow( \CMB2_Field $field, $fieldID ) {
            \Forked\CMB2\CMB2Grid\Cmb2\Utils::appendGroupFieldArg( $field, $fieldID, 'before_row', '<div class="row cmb2GridRow">' );
        }
