 ...
 */
if ( ! class_exists( 'Forked\CMB2\CMB2Grid\Grid\Column' ) ) {
	...
	class Column {
		...
		public function __construct( $field, Cmb2Grid $grid ) {
			...
			} elseif ( is_a( $field, 'Forked\CMB2\CMB2Grid\Grid\Group\Cmb2GroupGrid' ) ) {
		...
		public function setColumnClassCmb2() {
			...
			if ( $field->args['type'] === 'group' ) {
				\Forked\CMB2\CMB2Grid\Cmb2\Utils::initializeFieldArg( $field, 'before_group' );
				\Forked\CMB2\CMB2Grid\Cmb2\Utils::initializeFieldArg( $field, 'after_group' );
				$field->args['before_group'] .= "<div class=\"{$columnClass}\">";
				$field->args['after_group']  .= '</div>';
			} else {
				\Forked\CMB2\CMB2Grid\Cmb2\Utils::initializeFieldArg( $field, 'before_row' );
				\Forked\CMB2\CMB2Grid\Cmb2\Utils::initializeFieldArg( $field, 'after_row' );
