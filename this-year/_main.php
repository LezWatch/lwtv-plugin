		...
		<nav aria-label="This Year Navigation" role="navigation" class="yikes-pagination">
			<ul class="pagination justify-content-center">
				...
				if ( $thisyear !== $lastyear ) {
					?>
					<li class="page-item first me-auto"><a href="<?php echo esc_url( $baseurl . $lastyear . '/' . $view ); ?>" class="page-link"><?php echo ( new LWTV_Functions() )->symbolicons( 'caret-left-circle.svg', 'fa-chevron-circle-left' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> First (<?php echo (int) $lastyear; ?>)</a></li> 
