...
class LWTV_AdminMenu_Validate_Actor_Empty_Build {
	/**
	...
	public static function make() {
		...
		$last_run = LWTV_AdminMenu_Validation::last_run( 'actor_empty' );
		...
		if ( empty( $items ) || ! is_array( $items ) ) {
			...
			<div class="lwtv-tools-table">
				<table class="widefat fixed" cellspacing="0">
					...
					<tbody>
						<?php LWTV_AdminMenu_Validation::table_content( $items ); ?>
					</tbody>
				</table>
			</div>
			<?php
