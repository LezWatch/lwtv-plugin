...
function lezchars_quick_edit_js() {
	...
	// Sexuality
	function set_inline_lez_quick_edit_defaults( sexualitySet, genderSet, nonce ) {
...
function lezchars_quick_edit_link($actions, $post) {
	...
	$actions['inline hide-if-no-js'] .= " onclick=\"set_inline_lez_quick_edit_defaults('{$sex_terms[0]->name}', '{$gender_terms[0]->name}', '{$nonce}')\">";
