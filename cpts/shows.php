...
// Adding to Right Now
add_action( 'dashboard_glance_items', 'lwtv_shows_cpt_right_now' );

function lwtv_shows_cpt_right_now() {
...
add_action('admin_head', 'lwtv_shows_cpt_css');