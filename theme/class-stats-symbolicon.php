...
class LWTV_Theme_Stats_Symbolicon {
	/**
	...
	public function make( $stats_type ) {
		...
		// Defaults:
		$stats_array = array(
			'image' => ( new LWTV_Features() )->symbolicons( 'graph-bar.svg', 'fa-chart-area' ),
			'intro' => '',
		);
		...
		switch ( $stats_type ) {
			case 'death':
				$stats_array['image'] = ( new LWTV_Features() )->symbolicons( 'grim-reaper.svg', 'fa-ban' );
				...
				break;
			case 'characters':
				$stats_array['image'] = ( new LWTV_Features() )->symbolicons( 'chart-bar.svg', 'fa-chart-bar' );
				$stats_array['intro'] = 'Data specific to queer characters.';
				break;
			case 'actors':
				$stats_array['image'] = ( new LWTV_Features() )->symbolicons( 'graph-line.svg', 'fa-chart-line' );
				$stats_array['intro'] = 'Data specific to actors who play queer characters.';
				break;
			case 'shows':
				$stats_array['image'] = ( new LWTV_Features() )->symbolicons( 'chart-pie.svg', 'fa-chart-pie' );
				$stats_array['intro'] = 'Data specific to TV shows with queer characters.';
				break;
			case 'nations':
				$stats_array['image'] = ( new LWTV_Features() )->symbolicons( 'globe.svg', 'fa-globe' );
				$stats_array['intro'] = 'Data specific to queer representation on shows by nation.';
				break;
			case 'stations':
				$stats_array['image'] = ( new LWTV_Features() )->symbolicons( 'satellite-signal.svg', 'fa-bullhorn' );
